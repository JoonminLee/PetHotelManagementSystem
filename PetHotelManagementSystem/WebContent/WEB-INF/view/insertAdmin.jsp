      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <div class="sidebar-header d-flex align-items-center">
            <div class="avatar"><a href="#" onclick="$.photoUpload()"><img id="profilePicture" src="${emp.ePhoto }" onerror="this.src='/images/emp/admin.png'" class="img-fluid rounded-circle"></a></div>
            <div class="title">
