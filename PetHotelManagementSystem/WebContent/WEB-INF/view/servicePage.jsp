...
<body class="is-preload">
	...
	<section id="intro" class="main style1 dark fullscreen">
		<div class="content">
			...
			<p>
				Welcome to <strong>Pet Hotel</strong>
			</p>
			<footer>
	...
	<section id="one" class="main style2 right dark fullscreen">
		<div class="content box style2">
			<header>
				<h2>Love Pet, Live Together</h2>
			</header>
			<p>저희는 반려동물을 사랑하는 마음으로 보호자와 변려동물의 행복한 공존, 사람과 반려동물이 함께 어울리는 세상을
				만들기 위해 즐거운 일들을 합니다. 우리는 보호자를 대신하여 반려동물이 스트레스 받지 않고 힐링이 되는 서비스를 제공하고,
				보호자에게는 믿고 맡길 수 있는 안심 서비스를 제공해 최고의 펫호텔이 되고자 하는 목표를 가지고 나아가고 있습니다.</p>
		</div>
		<a href="#footer" class="button style2 down anchored">Next</a>
	</section>
	<!-- Two -->
	<section id="two" class="main style2 left dark fullscreen">
		<div class="content box style2">
			...
			<p>실용성과 편안함은 저희 호텔이 추구하는 가치와 철학입니다. 필요한 것은 더 충실히 갖추고, 불필요한 것은 과감히
				배제하였습니다. 편리한 접근성과 집보다 안락한 객실로 고객에게 진정한 휴식을 제공하고, 지역의 특색을 포함하는 디자인과
